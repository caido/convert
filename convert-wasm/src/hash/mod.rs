use convert::{Operation, Sha2Version};
...
impl Sha1Hash {
    ...
    pub fn new() -> Sha1Hash {
        Sha1Hash {
            sha1_hash: convert::Sha1Hash::new(),
        }
    }
...
impl Sha2Hash {
    ...
    pub fn new(params: ISha2Hash) -> Result<Sha2Hash, JsValue> {
        ...
        Ok(Sha2Hash {
            sha2_hash: convert::Sha2Hash::new(version),
        })
    }
